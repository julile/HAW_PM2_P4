...
public class Vorstellung
{
    ...
    /**
     * Gibt an, ob ein bestimmter Platz bereits in einem anderen Kassenwerkzeug selektiert ist.
     * 
     * @param platz der Sitzplatz.
     * 
     * @return <code>true</code>, falls der Platz reserviert ist,
     *         <code>false</code> sonst.
     * 
     * @require platz != null
     * @require hatPlatz(platz)
    ...
    public synchronized boolean istPlatzReserviert(Platz platz)
    {
        ...
        return _reserviert[platz.getReihe()][platz.getSitz()];
    }
    
    /**
     * Reserviert einen Platz bei Auswahl
     * 
     * @param platz der Sitzplatz.
     * 
     * @return true, wenn: reservierung war erfolgreich
     * 
     * @require platz != null
     * @require hatPlatz(platz)
     * 
     * @ensure istPlatzVerkauft(reihe, sitz)
     */
    public synchronized boolean reservierePlatz(Platz platz)
    {
        assert platz != null : "Vorbedingung verletzt: platz != null";
        assert hatPlatz(platz) : "Vorbedingung verletzt: hatPlatz(platz)";
        
        if (!istPlatzReserviert(platz)) {
        	_reserviert[platz.getReihe()][platz.getSitz()] = true;
        	return true;
        } else {
        	return false;
        }
     ...
     */
    public synchronized boolean reservierePlaetze(Set<Platz> plaetze)
    {
        assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
        assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
     ...
     * @ensure istPlatzVerkauft(reihe, sitz)
     */
    public synchronized boolean unreservierePlatz(Platz platz)
    {
        assert platz != null : "Vorbedingung verletzt: platz != null";
        assert hatPlatz(platz) : "Vorbedingung verletzt: hatPlatz(platz)";
        
        if (istPlatzReserviert(platz)) {
        	_reserviert[platz.getReihe()][platz.getSitz()] = false;
        	return true;
        } else {
        	return false;
        }
     ...
     * @ensure alle angegebenen Plätze sind storniert
     */
    public synchronized boolean unreservierePlaetze(Set<Platz> plaetze)
    {
        assert plaetze != null : "Vorbedingung verletzt: plaetze != null";
        assert hatPlaetze(plaetze) : "Vorbedingung verletzt: hatPlaetze(plaetze)";
