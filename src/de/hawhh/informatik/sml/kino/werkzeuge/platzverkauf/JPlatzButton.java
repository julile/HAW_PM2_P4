...
class JPlatzButton extends JButton
{
    ...
    private static final Color FARBE_RESERVIERT = Color.GRAY;
...
//        }
    ...
    /**
     * Zeigt an, dass dieser Button in einem anderen Kassenwerkzeug ausgewählt wurde.
     * 
     * @param reserviert
     */
