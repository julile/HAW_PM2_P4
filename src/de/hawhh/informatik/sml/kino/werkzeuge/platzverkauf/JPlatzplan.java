...
class JPlatzplan extends JComponent
{
    ...
    /**
     * Markiert den angegebenen Platz als reserviert.
     * 
     * @param platz
     *            der Platz.
     * 
     * @require platz != null
     */
    public void markierePlatzAlsReserviert(Platz platz)
    {
        assert platz != null : "Vorbedingung verletzt: platz != null";
        _buttons[platz.getReihe()][platz.getSitz()].setReserviert(true);
        repaint();
    }
