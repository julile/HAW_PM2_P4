 ...
 * @version SoSe 2017
 */
public class PlatzVerkaufsWerkzeug extends ObservableSubwerkzeug implements SubwerkzeugObserver 
{
...
//                        informiereUeberAenderung();
    ...
    {
    	if ( istReservierenMoeglich(plaetze) && _vorstellung.reservierePlaetze(plaetze))
    	{
    ...
    /**
     * Prüft, ob die angegebenen Plätze alle reserviert werden können.
     */
    ...
    /**
     * Prüft, ob die angegebenen Plätze alle freigegeben werden können.
     */
